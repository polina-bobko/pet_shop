...
import close from '../../assets/icons/deleteCartItem.svg'
      ...
      {cartItems.length === 0 ? (
        ...
        <div className={styles.CartPage_itemsBox}>
          ...
          <div className={styles.CartPage_itemsBox_right}>
            <h3>Order details</h3>
            <div className={styles.totalQuantity}>{totalQuantity} items</div>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <div className={styles.totalPriceTitle}>Total</div>
